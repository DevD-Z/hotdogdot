...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  return (
    <div className="page-container space-y-6 sm:space-y-8">
      {/* Hero Banner */}
      <div className="relative min-h-[260px] sm:min-h-[300px] rounded-3xl overflow-hidden bg-slate-950 p-5 sm:p-8 border border-sky-900/50 shadow-2xl flex items-center">
        <img
          src="/app-logo.png"
          alt=""
          aria-hidden="true"
          className="absolute right-0 inset-y-0 h-full w-full sm:w-1/2 object-cover object-center opacity-35 sm:opacity-60"
        />
        ...
        <div className="relative z-10 max-w-xl space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-sky-500/20 border border-sky-500/30 text-sky-300 text-xs font-semibold">
            ...
            <span>hotdogdot · Lavalink Engine</span>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {recentlyPlayed.slice(0, 6).map((track, idx) => (
              <div
                ...
                className="surface-card p-3 rounded-2xl cursor-pointer group animate-item-enter"
              >
