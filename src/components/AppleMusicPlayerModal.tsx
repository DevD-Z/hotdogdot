...
export const AppleMusicPlayerModal: React.FC<AppleMusicPlayerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black text-white flex flex-col h-[100dvh] w-screen overflow-hidden select-none animate-page-enter pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
      ...
      {/* Top Header Bar */}
      <div className="relative z-20 h-16 px-3 sm:px-6 lg:px-10 flex items-center justify-between border-b border-zinc-800/80 bg-black/80 backdrop-blur-md shrink-0">
        <button
          onClick={onClose}
      ...
      <div className="relative z-10 flex-1 flex flex-col lg:flex-row items-center justify-start lg:justify-center p-3 sm:p-6 lg:p-10 gap-5 sm:gap-8 lg:gap-12 overflow-y-auto lg:overflow-hidden max-h-[calc(100dvh-64px)]">
